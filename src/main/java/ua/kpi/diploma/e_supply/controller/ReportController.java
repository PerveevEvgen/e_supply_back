...
import ua.kpi.diploma.e_supply.service.impl.PdfReportService;
import ua.kpi.diploma.e_supply.service.impl.ReportService;
...
public class ReportController {
    ...
    @PostMapping("/pdf")
    public ResponseEntity<String> getPdfReport(@RequestBody List<ReportResponseDTO>  request) {
